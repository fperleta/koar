...
anode_t
N_fwriter1_make (patch_t p, const char* fn, pnode_t in)
{
...
PATCHVM_fwriter1_make (patchvm_t vm, instr_t instr)
{
    ...
    reg_t val = { .tag = T_FWRITER1, .an = N_fwriter1_make (p, fn, in) };
...
anode_t
N_fwriter2_make (patch_t p, const char* fn, pnode_t inl, pnode_t inr)
{
